...
<head>
    ...
    <title>Adventureworks - Sales Amount</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Sales Amount</h1>
                    </div>
                                        ...
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php  
                                                 ...
                                                 $sql = "SELECT sum(Sales_Amount) as revenue from fact_sales";
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Rata-rata Sales Amount</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php
                                            $sql = "SELECT avg(Sales_Amount) as jumlah_transaksi from fact_sales";
                                            $query = mysqli_query($mysqli,$sql);
                                                 while($row2=mysqli_fetch_array($query)){
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-10 col-lg-10">
                            <div class="card shadow mb-4" style="height: 700px;">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Total Sales Amount 2011 - 2014</h6>
                                </div>
                                <!-- Card Body -->
                            <div class="card-body">
                                    ...
                                    <div>
                                        ...
                                        <script>
                                            ...
                                            var chart = Highcharts.chart('chartContainer', {
                                                ...
                                                title: {
                                                    text: 'Total Sales Amount 2011 - 2014'
                                                },
                                                plotOptions: {
                                                    series: {
                                                        dataLabels: {
                        ...
                        <div class="col-xl-10 col-lg-10">
                            <div class="card shadow mb-4" style="height: 700px;">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Total Sales Amount Category - Product</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    ...
                                    <div>
                                        ...
                                        <script>
                                            ...
                                            var chart = Highcharts.chart('chartContainer2', {
                                                ...
                                                title: {
                                                    text: 'Total Sales Amount Category - Product'
                                                },
                                                plotOptions: {
                                                    series: {
                                                        dataLabels: {
                        ...
                        <div class="col-xl-10 col-lg-10">
                                <div class="card shadow mb-4" style="height: 700px;">
                                    ...
                                    <div
                                        class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                        <h6 class="m-0 font-weight-bold text-primary">Total Sales Amount Wilayah
                                        </h6>
                                    </div>
                                    <!-- Card Body -->
                                    <div class="card-body">
                                        ...
                                        <div>
                                            ...
                                            var chart = Highcharts.chart('chartContainer1', {
                                                ...
                                                title: {
                                                    text: 'Total Sales Amount Wilayah'
                                                },
                                                plotOptions: {
                                                    series: {
                                                        dataLabels: {
                            ...
                            <div class="col-xl-10 col-lg-10">
                                <div class="card shadow mb-4" style="height: 700px;">
                                    ...
                                    <div
                                        class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                        <h6 class="m-0 font-weight-bold text-primary">Total Sales Amount Perbandingan Ship Method
                                        </h6>
                                    </div>
                                    <!-- Card Body -->
                                    <div class="card-body">
                                        ...
                                        <div>
                                            ...
                                            var chart = Highcharts.chart('chartContainer7', {
                                                ...
                                                title: {
                                                    text: 'Total Sales Amount Perbandingan Ship Method'
                                                },
                                                plotOptions: {
                                                    series: {
                                                        dataLabels: {
                            ...
                            <div class="col-xl-10 col-lg-10">
                                <div class="card shadow mb-4" style="height: 700px;">
                                    ...
                                    <div
                                        class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                        <h6 class="m-0 font-weight-bold text-primary">Total Sales Amount Perbandingan Special Offer
                                        </h6>
                                    </div>
                                    <!-- Card Body -->
                                    <div class="card-body">
                                        ...
                                        <div>
                                            ...
                                            var chart = Highcharts.chart('chartContainer8', {
                                                ...
                                                title: {
                                                    text: 'Total Sales Amount Perbandingan Special Offer'
                                                },
                                                plotOptions: {
                                                    series: {
                                                        dataLabels: {
